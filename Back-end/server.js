...
// Defina a rota para finalizar uma ordem de produção, passando o ID dinamicamente
app.put('/ordemProducao/finalizar/:id_ordem_producao', ordemProducao.finalizar_ordemProducao);
